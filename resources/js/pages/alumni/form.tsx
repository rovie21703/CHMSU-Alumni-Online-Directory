    ...
    >
      <div
        className={`w-4 h-4 rounded-full border-2 flex items-center justify-center flex-shrink-0 ${
          checked ? "border-[#1A5336]" : "border-gray-300"
        }`}
      >
    ...
    >
      <div
        className={`w-4 h-4 rounded border-2 flex items-center justify-center flex-shrink-0 ${
          checked ? "border-[#1A5336] bg-[#1A5336]" : "border-gray-300"
        }`}
      >
        {checked && (
      ...
      <nav className="bg-[#1A5336] border-b-4 border-[#FFB81C]" style={{ boxShadow: "inset 0 -8px 0 -4px #0033A0" }}>
        <div className="max-w-5xl mx-auto px-4 py-3 flex items-center gap-3">
          ...
          <div className="ml-auto">
            <Link
              href={route('login')}
              className="flex items-center gap-2 px-4 py-2 rounded-xl bg-white/10 hover:bg-white/20 border border-white/20 hover:border-white/40 text-white text-sm font-medium transition-all"
            >
              <ShieldCheck size={15} />
              Admin
            </Link>
            ...
            <div className="mb-6">
              ...
              <div className="grid grid-cols-2 md:grid-cols-4 gap-3">
                <RadioOption
                  ...
                  value="BCNTS"
                  label="BCNTS"
                  checked={schoolAttended === "BCNTS"}
                  onChange={() => {
                    setSchoolAttended("BCNTS");
                    setSchoolError("");
                  }}
                />
                <RadioOption
                  ...
                  value="PSC"
                  label="PSC"
                  checked={schoolAttended === "PSC"}
                  onChange={() => {
                    setSchoolAttended("PSC");
                    setSchoolError("");
                  }}
                />
                <RadioOption
                  ...
                  value="CHMSC"
                  label="CHMSC"
                  checked={schoolAttended === "CHMSC"}
                  onChange={() => {
                    setSchoolAttended("CHMSC");
                    setSchoolError("");
                  }}
                />
                <RadioOption
                  ...
                  value="CHMSU"
                  label="CHMSU"
                  checked={schoolAttended === "CHMSU"}
                  onChange={() => {
                    setSchoolAttended("CHMSU");
                    setSchoolError("");
                  }}
                />
              </div>
            </div>
            {schoolError && <p className={`${errorClass} mb-4`}>{schoolError}</p>}
            ...
            {showEmploymentDetails && (
              ...
              >
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-5">
                  ...
                  {/* Company */}
                  <div className="md:col-span-2">
                    <label className={labelClass}>Name of Company / Organization and Address</label>
                    <textarea
                      {...register("company")}
                      className={`${inputClass} resize-none`}
                      rows={2}
                      placeholder="COMPANY NAME AND COMPLETE ADDRESS"
                      onChange={(e) => {
                        e.target.value = e.target.value.toUpperCase();
